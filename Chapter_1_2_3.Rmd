...
1. The points are not blue because color is within aes() and aes it is trying to find the variable blue to apply different colors to the values of that variable. However, this variable is passed as a string and hence, the point get the first color value that they would got if such a variable existed. In this case the color is pinkish.
